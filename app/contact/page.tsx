    ...
    <main className="min-h-screen bg-base">
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="grid gap-12 lg:grid-cols-[1.2fr_0.8fr] items-start">
          ...
          <div className="rounded-3xl border border-slate-800 bg-surface p-8 shadow-sm">
            <form className="space-y-6">
              <label className="block">
                ...
                <input
                  ...
                  className="mt-2 w-full rounded-2xl border border-slate-700 bg-base px-4 py-3 text-sm text-white placeholder-slate-600 focus:border-accent focus:outline-none focus:ring-2 focus:ring-accent/20"
                />
              </label>
              <label className="block">
              ...
              <button
                type="submit"
                className="w-full rounded-2xl bg-accent px-5 py-3 text-sm font-semibold text-black hover:bg-accent-dark"
