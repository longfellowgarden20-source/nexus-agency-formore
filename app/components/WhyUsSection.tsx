...
export function WhyUsSection() {
  return (
    <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-20 bg-base">
      ...
      <div className="mt-16 grid gap-6 lg:grid-cols-2">
        {[
          ...
          <div key={item.title} className="rounded-3xl border border-slate-800 p-8 bg-surface hover:border-accent/30" style={{ transition: 'border-color 300ms' }}>
